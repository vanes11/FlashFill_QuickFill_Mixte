      ...
      <strong><u>Contruction des blocs</u></strong> 
        <div>
              <ul>
                  ...
                  <button @click="SendDataQuickFill" id="sendquick">Send</button>
                  <button @click="SendDataQuickFillMoins" id="sendquickmoins">Send</button>
  ...
  export default{
    ...
    methods: 
    {
      ...
      contextMenuOpen:function (args) 
      {
        ...
        SendDataQuickFillMoins : function()
        {
              ...
              if(that.ChoiseQuickFill.choix == 1)
              {
                  ...
                  setTimeout(function cb() {
                        ...
                        axios.post("http://localhost:8000/QuickFillMoins/sessions/QuickExs", {
              ...
              else if(that.ChoiseQuickFill.choix == 2)
              {
                  ...
                  setTimeout(function cb() {
                        ...
                        axios.post("http://localhost:8000/QuickFillMoins/filter/QuickExsFilter", {
              ...
              else if(that.ChoiseQuickFill.choix == 3)
              {
                  ...
                  setTimeout(function cb() {
                        ...
                        axios.post("http://localhost:8000/QuickFillMoins/manyblocs/QuickExsManyBlock", {
                    ...
                    spreadsheet.addRibbonTabs([  /* ajout les nouveaux menu sur le ruban */
                          ...
                          { header: { text: 'GenerateResult' }, content: 
                            [
                                                                    ...
                                                                    setTimeout(function knr() {
                                                                                ...
                                                                                if(MessageCles)
                                                                                {
                                                                                      ...
                                                                                      var sortieUtiliser = listechoix[0];
                                                                                        ...
                                                                                        var sendquickmoins = document.getElementById("sendquickmoins");
                                                                                        var sendquick = document.getElementById("sendquick");                                                                                 
                                                                                        sendquick.style.display = "block";
                                                                                        sendquickmoins.style.display="none";
                                ...
                                { text: 'QuickFillMoins', tooltipText: 'QuickFillMoins',
                                click : function() 
                                {
                                                                    ...
                                                                    setTimeout(function knr() {
                                                                                ...
                                                                                if(MessageCles)
                                                                                {
                                                                                      ...
                                                                                      var sortieUtiliser = listechoix[0];
                                                                                        ...
                                                                                        var sendquickmoins = document.getElementById("sendquickmoins");
                                                                                        var sendquick = document.getElementById("sendquick");
                                                                                        sendquick.style.display = "none";
                                                                                        sendquickmoins.style.display="block";
